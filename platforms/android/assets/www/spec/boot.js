 ...
 * Jasmine boot script
 * 
 * This is a customized version of the boot file, do not overwrite!
 * 
 */
...
(function() {
     ...
     * ## Require &amp; Instantiate
     *
     * Require Jasmine's core files. Specifically, this requires and attaches 
     * all of Jasmine's code to the `jasmine` reference.
     */
     ...
     *
     * Build up the functions that will be exposed as the Jasmine public 
     * interface. A project can customize, rename or alias any of these 
     * functions as desired, provided the implementation remains unchanged.
     */
     ...
     * so a project can use the public interface directly. For example, calling
    ...
    var htmlReporter = new jasmine.HtmlReporter({
        ...
        getContainer: function() {
            return document.getElementById('jasmine_out');
        },
     ...
     * instance and then executing the loaded Jasmine environment. All of this 
     * will happen after all of the specs are loaded.
     */
